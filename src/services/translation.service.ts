...
const translations = {
  en: {
    ...
    dataManagement: 'Data Synchronization',
    backupDesc: 'Backup your entire database (products, images, sales) to a file. Use this to transfer data between devices.',
    downloadBackup: 'Download Backup',
    restoreBackup: 'Restore Backup',
    confirmRestore: 'WARNING: This will overwrite all current data with the backup file. Are you sure?',
  ...
  es: {
    ...
    dataManagement: 'Sincronización de Datos',
    backupDesc: 'Guarda una copia completa de tu base de datos (productos, fotos, ventas) en un archivo. Úsalo para mover tus datos a otro dispositivo.',
    downloadBackup: 'Descargar Copia de Seguridad',
    restoreBackup: 'Restaurar Copia de Seguridad',
    confirmRestore: 'ADVERTENCIA: Esto sobrescribirá todos los datos actuales con el archivo de respaldo. ¿Estás seguro?',
    ...
    auto: 'Auto',
    confirmDeleteProduct: '¿Seguro que quieres eliminar este producto y TODAS sus variantes?',
    confirmDeleteVariant: '¿Seguro que quieres eliminar esta variante específica?',
    // Cash Control & Expenses
